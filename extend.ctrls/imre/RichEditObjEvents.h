...
#define CLICK_AUDIO_PLAY				(RICHOBJ_EVENT_BASE+11)
#define CLICK_AUDIO_PLAYING				(RICHOBJ_EVENT_BASE+12)
#define CLICK_VIDEODOWNLOAD				(RICHOBJ_EVENT_BASE+13)
#define CLICK_VIDEOPLAY					(RICHOBJ_EVENT_BASE+14)
